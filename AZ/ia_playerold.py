    ...
    def playRandom(self, board,step):
                ...
                if self.canPlayHere(board,step,4,2):
                    ...
                    if self.canPlayHere(board,step,2,0):
                        ...
                        if self.canPlayHere(board,step,2,4):
                            ...
                            if self.canPlayHere(board, step, 0, 1):
                                playable.append((0, 1))
                            else:
                                if self.canPlayHere(board, step, 0, 3):
                                    playable.append((0, 3))
                                else:
                                    if self.canPlayHere(board, step, 4, 1):
                                        playable.append((4, 1))
                                    else:
                                        if self.canPlayHere(board, step, 4, 3):
                                            playable.append((4, 3))
                                        else:
                                            if self.canPlayHere(board, step, 0, 0):
                                                playable.append((0, 0))
                                            else:
                                                if self.canPlayHere(board, step, 0, 4):
                                                    playable.append((0, 4))
                                                else:
                                                    if self.canPlayHere(board, step, 1, 4):
                                                        playable.append((1, 4))
                                                    else:
                                                        if self.canPlayHere(board, step, 1, 0):
                                                            playable.append((1, 0))
                                                        else:
                                                            if self.canPlayHere(board, step, 2, 0):
                                                                playable.append((2, 0))
                                                                ...
                                                                if self.canPlayHere(board, step, 2, 4):
                                                                    ...
                                                                    if self.canPlayHere(board, step, 3, 0):
                                                                        playable.append((3, 0))
                                                                    else:
                                                                        if self.canPlayHere(board, step, 3, 4):
                                                                            playable.append((3, 4))
                                                                        else:
                                                                            if self.canPlayHere(board, step, 4, 0):
                                                                                playable.append((4, 0))
                                                                            else:
                                                                                if self.canPlayHere(board, step, 4, 4):
                                                                                    playable.append((4, 4))
                                                                                else:
                                                                                    for i in range(self.gameSize):
                                                                                        for j in range(self.gameSize):
                                                                                            if self.canPlayHere(board,
                                                                                                                step, i,
                                                                                                                j):
                                                                                                playable.append((i, j))
        ...
        if(step==1):
            if self.playerColor == 'black':
                ...
                player = -1
            depth = 1
            nodes = self.createNode(board,depth,player,0)
            alpha=-1000
            beta=1000
            al=0
            bt=0
            ...
            self.sumNodes(nodes, depth, player, som, al, bt)
            print(nodes)
            choice = []
            for i in range(len(nodes)):
                m = []
                m.append(nodes[i])
                choice.append(self.printNode(m, depth, player,alpha,beta))
            if player == 1:
